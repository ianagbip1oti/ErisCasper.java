 ...
 * @see <a href="https://discordapp.com/developers/applications/me">Discord Documentation - My
 *     Apps</a>
 * @see net.dv8tion.jda.client.JDAClient#getApplications() JDAClient.getApplications()
 * @see net.dv8tion.jda.client.JDAClient#getApplicationById(String)
 *     JDAClient.getApplicationById(String)
 */
public interface Application extends ISnowflake {

  /**
   * Creates a new Bot for this Application. <b>This cannot be undone!</b> A new Bot will only be
   * created if no bot-account is already assigned, otherwise the existing one is returned. A newly
   * created Bot-account will have its name set to the name of the Application.
   *
   ...
   *
   * <ul>
   *   <li>{@link net.dv8tion.jda.core.requests.ErrorResponse#UNKNOWN_APPLICATION
   *       UNKNOWN_APPLICATION} <br>
  ...
  /**
   * Deletes this Application and its assigned Bot (if present). <b>This cannot be undone!</b>
   *
   * <p>Possible {@link net.dv8tion.jda.core.requests.ErrorResponse ErrorResponses} for this update
   * include the following:
   *
   ...
   *
   * <p>This means that additional OAuth2 steps are required to authorize the application to make a
   * bot join a guild like {@code &response_type=code} together with a valid {@code &redirect_uri}.
   * <br>
   * For more information look at the <a
   * href="https://discordapp.com/developers/docs/topics/oauth2">Discord OAuth2 documentation</a>.
   *
   ...
   *
   * @return The {@link Application.Bot} assigned to this application, or {@code null} if no bot is
   *     assigned
   */
   ...
   *
   * @return The description of the application or an empty {@link String} if no description is
   *     defined
   */
  ...
  /**
   * The icon id of the application. <br>
   * The application icon is <b>not</b> necessarily the same as the bot's avatar!
   *
  ...
  /**
   * The icon-url of the application. <br>
   * The application icon is <b>not</b> necessarily the same as the bot's avatar!
   *
  ...
  /**
   * The {@link net.dv8tion.jda.core.JDA JDA} instance of this Application (the one owning this
   * application).
   *
  ...
  /**
   * Returns the {@link net.dv8tion.jda.client.managers.ApplicationManager ApplicationManager} for
   * this Application. In the ApplicationManager, you can modify things like the name and icon of
   * this Application.
   *
  ...
  /**
   * Returns the {@link net.dv8tion.jda.client.managers.ApplicationManagerUpdatable
   * ApplicationManagerUpdatable} for this Application. In the ApplicationManager, you can modify
   * things like the name and icon of this Application. <br>
   * This can be used to bulk update application settings.
   *
  ...
  /**
   * The name of this application. <br>
   * The application name is <b>not</b> necessarily the same as the bot's name!
   *
  ...
  /**
   * Whether the bot is public or not. Public bots can be added by anyone. When false only the owner
   * can invite the bot to servers.
   *
   ...
   * </ul>
   *
   * @return {@link net.dv8tion.jda.core.requests.RestAction RestAction} - Type: {@link Application}
   *     <br>
  ...
  /**
   * Represents a Bot assigned to an Application To change its Username, login to JDA and use the
   * {@link net.dv8tion.jda.core.managers.AccountManager AccountManager}.
   */
  interface Bot extends ISnowflake {
     ...
     *
     * <p>The link is provided in the following format: <br>
     * {@code
     ...
     *
     * @param permissions Possibly empty {@link java.util.List List} of {@link
     *     net.dv8tion.jda.core.Permission Permissions} that should be requested via invite.
     ...
     * Unnecessary query parameters are stripped.
     *
     * @param permissions Possibly empty array of {@link net.dv8tion.jda.core.Permission
     *     Permissions} that should be requested via invite.
     * @return The link used to invite the bot
     */
     ...
     * Unnecessary query parameters are stripped.
     *
     * @param guildId The id of the pre-selected guild.
     * @param permissions Possibly empty {@link java.util.List List} of {@link
     *     net.dv8tion.jda.core.Permission Permissions} that should be requested via invite.
     * @return The link used to invite the bot
     */
    ...
    /**
     * The token used to login to JDA with this Bot <br>
     * This can be used in {@link net.dv8tion.jda.core.JDABuilder#setToken(String)
     * JDABuilder.setToken(String)}
     *
    ...
    /**
     * Generates a new token for this bot. <br>
     * <b>This invalidates the old one!</b>
     *
