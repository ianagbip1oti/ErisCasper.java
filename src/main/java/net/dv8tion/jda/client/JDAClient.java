...
public interface JDAClient {
   ...
   * MentionPaginationAction} allows to filter by whether the messages mention everyone or a role.
   *
   * <p><b>To target recent mentions from all over Discord use {@link #getRecentMentions()}
   * instead!</b>
   *
   ...
   * @throws net.dv8tion.jda.core.exceptions.GuildUnavailableException If the specified Guild is not
   *     currently {@link net.dv8tion.jda.core.entities.Guild#isAvailable() available}
   * @return {@link net.dv8tion.jda.client.requests.restaction.pagination.MentionPaginationAction
   *     MentionPaginationAction}
   */
  ...
  /**
   * Creates a new {@link net.dv8tion.jda.client.entities.Application Application} for this user
   ...
   *
   * <ul>
   *   <li>{@link net.dv8tion.jda.core.requests.ErrorResponse#MAX_OAUTH_APPS MAX_OAUTH_APPS} <br>
   ...
   *     32 characters long
   * @return A specific {@link net.dv8tion.jda.client.requests.restaction.ApplicationAction
  ...
  /**
   * Retrieves all {@link net.dv8tion.jda.client.entities.Application Applications} owned by this
   * user account.
   *
   * @return {@link net.dv8tion.jda.core.requests.RestAction RestAction} - Type: {@link
   *     java.util.List List}{@literal <}{@link net.dv8tion.jda.client.entities.Application
  ...
  /**
   * Retrieves a specific {@link net.dv8tion.jda.client.entities.Application Application} owned by
   * this user account.
   *
  ...
  /**
   * Retrieves all {@link net.dv8tion.jda.client.entities.AuthorizedApplication
   ...
   *     <}{@link net.dv8tion.jda.client.entities.AuthorizedApplication
  ...
  /**
   * Retrieves a specific {@link net.dv8tion.jda.client.entities.AuthorizedApplication
   * AuthorizedApplication} authorized by this user account.
   *
   * <p>Possible {@link net.dv8tion.jda.core.requests.ErrorResponse ErrorResponses}:
   *
   * <ul>
   *   <li>{@link net.dv8tion.jda.core.requests.ErrorResponse#UNKNOWN_TOKEN UNKNOWN_TOKEN} <br>
   *       The Application either doesn't exist or isn't authorized by this user account.
   * </ul>
   *
   * @param id The id of the {@link net.dv8tion.jda.client.entities.AuthorizedApplication
