...
/**
 * Facade for an {@link net.dv8tion.jda.client.managers.ApplicationManagerUpdatable
 * ApplicationManagerUpdatable} instance. <br>
...
public class ApplicationManager {
  ...
  /**
   * Sets the <b><u>description</u></b> of the selected {@link
   * net.dv8tion.jda.client.entities.Application Application}. <br>
   * Wraps {@link net.dv8tion.jda.client.managers.ApplicationManagerUpdatable#getDescriptionField()
   * ApplicationManagerUpdatable#getDescriptionField()}.
   *
   * <p>A description <b>must not</b> be than 400 characters long!
   *
   * @param description The new description for the selected {@link
   ...
   * @return {@link net.dv8tion.jda.core.requests.RestAction} <br>
   *     Update RestAction from {@link ApplicationManagerUpdatable#update() #update()}
  ...
  /**
   * Sets the <b><u>code grant state</u></b> of the selected {@link
   * net.dv8tion.jda.client.entities.Application Application's} bot. <br>
   * Wraps {@link
   * net.dv8tion.jda.client.managers.ApplicationManagerUpdatable#getDoesBotRequireCodeGrantField()
   * ApplicationManagerUpdatable#getDoesBotRequireCodeGrantField()}.
   *
   * @param requireCodeGrant The new state for the selected {@link
  ...
  /**
   * Sets the <b><u>icon</u></b> of the selected {@link net.dv8tion.jda.client.entities.Application
   * Application}. <br>
   * Wraps {@link net.dv8tion.jda.client.managers.ApplicationManagerUpdatable#getIconField()
   * ApplicationManagerUpdatable#getIconField()}.
   *
   * @param icon The new {@link net.dv8tion.jda.core.entities.Icon Icon} for the selected {@link
   *     net.dv8tion.jda.client.entities.Application Application}
   * @return {@link net.dv8tion.jda.core.requests.RestAction} <br>
   *     Update RestAction from {@link ApplicationManagerUpdatable#update() #update()}
  ...
  /**
   * Sets the <b><u>public state</u></b> of the selected {@link
   * net.dv8tion.jda.client.entities.Application Application's} bot. <br>
   * Wraps {@link net.dv8tion.jda.client.managers.ApplicationManagerUpdatable#getIsBotPublicField()
   * ApplicationManagerUpdatable#getIsBotPublicField()}.
   *
   * @param botPublic The new state for the selected {@link
   *     net.dv8tion.jda.client.entities.Application Application's} bot
   * @return {@link net.dv8tion.jda.core.requests.RestAction} <br>
   *     Update RestAction from {@link ApplicationManagerUpdatable#update() #update()}
  ...
  /**
   * Sets the <b><u>name</u></b> of the selected {@link net.dv8tion.jda.client.entities.Application
   * Application}. <br>
   * Wraps {@link net.dv8tion.jda.client.managers.ApplicationManagerUpdatable#getNameField()
   ...
   * long!
   *
   * @param name The new name for the selected {@link net.dv8tion.jda.client.entities.Application
   *     Application}
   * @throws IllegalArgumentException If the provided name is {@code null}, less than 2 or more than
   *     32 characters long
   * @return {@link net.dv8tion.jda.core.requests.RestAction} <br>
   *     Update RestAction from {@link ApplicationManagerUpdatable#update() #update()}
  ...
  /**
   * Sets the <b><u>redirect uris</u></b> of the selected {@link
   * net.dv8tion.jda.client.entities.Application Application}. <br>
   * Wraps {@link net.dv8tion.jda.client.managers.ApplicationManagerUpdatable#getRedirectUrisField()
   ...
   * null}!
   *
   * @param redirectUris The new redirect uris for the selected {@link
   *     net.dv8tion.jda.client.entities.Application Application}
   * @throws IllegalArgumentException If either the provided {@link java.util.List List} or one of
   *     the uris is {@code null}
   * @return {@link net.dv8tion.jda.core.requests.RestAction} <br>
   *     Update RestAction from {@link ApplicationManagerUpdatable#update() #update()}
   * @see net.dv8tion.jda.client.managers.ApplicationManagerUpdatable#getIconField()
   * @see net.dv8tion.jda.client.managers.ApplicationManagerUpdatable#update()
