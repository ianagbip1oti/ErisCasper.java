 ...
 * create a {@link net.dv8tion.jda.client.entities.Application Application}. This extension allows
 * setting properties before executing the action.
 *
 * @since 3.0
...
public class ApplicationAction extends RestAction<Application> {
  ...
  protected RequestBody finalizeData() {
    ...
    if (this.icon != null) object.put("icon", this.icon.getEncoding());
  ...
  /**
   * Sets the <b><u>description</u></b> for the new {@link
   * net.dv8tion.jda.client.entities.Application Application}. Passing {@code null} or an empty
   * {@link String} will reset the description.
   *
   * <p>A description <b>must not</b> be than 400 characters long!
   *
   * @param description The description for new {@link net.dv8tion.jda.client.entities.Application
   *     Application}
  ...
  /**
   * Sets the {@link net.dv8tion.jda.core.entities.Icon Icon} of the selected {@link
   * net.dv8tion.jda.client.entities.Application Application}.
   *
   * @param icon The {@link net.dv8tion.jda.core.entities.Icon Icon} for new {@link
   *     net.dv8tion.jda.client.entities.Application Application}
   * @return The current ApplicationAction for chaining
   */
  ...
  /**
   * Sets the <b><u>name</u></b> for the new {@link net.dv8tion.jda.client.entities.Application
   * Application}.
   *
  ...
  public ApplicationAction setName(final String name) {
    if (name == null || name.length() < 2 || name.length() > 32)
      throw new IllegalArgumentException(
          "The application name must not be null and in the range of 2-32!");
    this.name = name;
    return this;
  }
}
