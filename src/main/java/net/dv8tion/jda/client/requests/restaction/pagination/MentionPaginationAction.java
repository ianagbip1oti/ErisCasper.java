 ...
 * that paginates the endpoint {@link net.dv8tion.jda.core.requests.Route.Self#GET_RECENT_MENTIONS
 * Route.Self.GET_RECENT_MENTIONS}.
 *
 * <p><b>Must provide not-null {@link net.dv8tion.jda.core.entities.Guild Guild} to compile a valid
 * guild mentions pagination route.</b>, else it uses the global pagination route.
 *
 * <h2>Limits:</h2>
 *
 * Minimum - 1 <br>
...
public class MentionPaginationAction extends PaginationAction<Message, MentionPaginationAction> {
  ...
  /**
   * Creates a new MentionPaginationAction <br>
   * This constructor effectively makes this target all recent mentions to get the recent mentions
   * for a specific {@link net.dv8tion.jda.core.entities.Guild Guild} use {@link
   * #MentionPaginationAction(net.dv8tion.jda.core.entities.Guild)} instead!
   *
  ...
  /**
   * Creates a new MentionPaginationAction <br>
   * This constructor effectively makes this target specifically only the recent mentions for the
   * specified {@link net.dv8tion.jda.core.entities.Guild Guild}! <br>
   * To get the global scope use {@link #MentionPaginationAction(net.dv8tion.jda.core.JDA)} instead.
   *
   ...
   * MentionPaginationAction. <br>
   * This can be {@code null} if this MentionPaginationAction does not target mentions from a
   * specific Guild!
   *
  ...
  /**
   * Sets whether this MentionPaginationAction should include mentions that mention the public role
   * of a Guild. <br>
   * Default: {@code true}
   *
  ...
  /**
   * Sets whether this MentionPaginationAction should include mentions that mention a role in a
   * Guild. <br>
   * Default: {@code true}
   *
  ...
  protected Route.CompiledRoute finalizeRoute() {
    ...
    if (guild != null) route = route.withQueryParams("guild_id", guild.getId());

    if (before != null) route = route.withQueryParams("before", before);
