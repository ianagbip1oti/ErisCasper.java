...
/**
 * A special Message that can only be sent to a {@link net.dv8tion.jda.webhook.WebhookClient
 * WebhookClient}. <br>
 * This message provides special attributes called {@code username} and {@code avatar_url} which
 * override the default username and avatar of a Webhook message.
 *
...
public class WebhookMessage {
  ...
  /**
   * Creates a new WebhookMessage instance with the provided {@link
   * net.dv8tion.jda.core.entities.MessageEmbed MessageEmbeds}
   *
  ...
  /**
   * Creates a new WebhookMessage instance with the provided {@link
   * net.dv8tion.jda.core.entities.Message Message} <br>
   * <b>This does not copy the attachments of the provided message!</b>
   *
  ...
  protected RequestBody getBody() {
    ...
    if (!embeds.isEmpty()) {
      ...
      for (MessageEmbed embed : embeds) array.put(embed.toJSONObject());
    ...
    if (isFile()) {
      ...
      return builder
          .addFormDataPart("file", fileName, MiscUtil.createRequestBody(OCTET, file))
