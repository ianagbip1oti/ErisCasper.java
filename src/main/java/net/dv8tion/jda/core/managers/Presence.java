...
public interface Presence {
   ...
   *
   * @return The {@link net.dv8tion.jda.core.OnlineStatus OnlineStatus} of the current session
   */
   ...
   * This might not be what the Discord Client displays due to session clashing!
   *
   * @return The {@link net.dv8tion.jda.core.entities.Game Game} of the current session or null if
   *     no game is set
   */
  Game getGame();
  ...
  /**
   * Sets the {@link net.dv8tion.jda.core.entities.Game Game} for this session. <br>
   ...
   *
   * <p>Examples: <br>
   * {@code presence.setGame(Game.playing("Thrones"));} <br>
   * {@code presence.setGame(Game.streaming("Thrones", "https://twitch.tv/EasterEggs"));}
   *
   ...
   *
   * @param status The {@link net.dv8tion.jda.core.OnlineStatus OnlineStatus} for this session (See
   *     {@link #setStatus(OnlineStatus)})
   * @param game The {@link net.dv8tion.jda.core.entities.Game Game} for this session (See {@link
   *     #setGame(Game)} for more info)
   * @param idle Whether to mark this session as idle (useful for client accounts {@link
   *     #setIdle(boolean)})
   * @throws java.lang.IllegalArgumentException If the specified OnlineStatus is {@link
   *     net.dv8tion.jda.core.OnlineStatus#UNKNOWN UNKNOWN}
   */
  void setPresence(OnlineStatus status, Game game, boolean idle);

  /**
   * Sets two presence fields of this session. <br>
