...
/**
 * An {@link #update(String) updatable} manager that allows to modify account settings like the
 * {@link #getNameField() username} or the {@link #getAvatarField() avatar}.
 *
 * <p>This manager allows to modify multiple fields at once by getting the {@link
 * net.dv8tion.jda.core.managers.fields.AccountField AccountFields} for specific properties and
 * setting or resetting their values; followed by a call of {@link #update(String)}!
 *
 * <p>The {@link net.dv8tion.jda.core.managers.AccountManager AccountManager} implementation
 * simplifies this process by giving simple setters that return the {@link #update(String) update}
 * {@link net.dv8tion.jda.core.requests.RestAction RestAction}
 *
 * <p><b>To update the {@link net.dv8tion.jda.core.entities.Game Game} or {@link
 * net.dv8tion.jda.core.OnlineStatus OnlineStatus} for the current session use the {@link
 * net.dv8tion.jda.core.managers.Presence Presence} instance of the corresponding JDA instance</b>
 */
public class AccountManagerUpdatable {
   ...
   *
   * @param selfUser A {@link net.dv8tion.jda.core.entities.SelfUser SelfUser} instance that
  ...
  /**
   * The {@link net.dv8tion.jda.core.entities.SelfUser SelfUser} that will be modified by this
   * AccountManagerUpdatable instance. <br>
  ...
  /**
   * An {@link net.dv8tion.jda.core.managers.fields.AccountField AccountField} for the {@code
   ...
   * setValue(String)} on the returned {@link net.dv8tion.jda.core.managers.fields.AccountField
   * AccountField} instance.
   *
   * <p>A username <b>must not</b> be {@code null} nor less than 2 characters or more than 32
   * characters long! <br>
   ...
   *
   * @return {@link net.dv8tion.jda.core.managers.fields.AccountField AccountField} - Type: {@code
   *     String}
   */
  ...
  /**
   * An {@link net.dv8tion.jda.core.managers.fields.AccountField AccountField} for the {@code
   * avatar} of the currently logged in account.
   *
   * <p>To set the value use {@link net.dv8tion.jda.core.managers.fields.Field#setValue(Object)
   * setValue(Icon)} on the returned {@link net.dv8tion.jda.core.managers.fields.AccountField
   * AccountField} instance. <br>
   * An {@link net.dv8tion.jda.core.entities.Icon Icon} can be retrieved through one of the static
   * {@code Icon.from(...)} methods
   *
   * <p>Providing {@code null} as value will cause the {@link
   * net.dv8tion.jda.core.entities.SelfUser#getDefaultAvatarId() default avatar} for this account to
   * be used. <br>
   * Otherwise {@link net.dv8tion.jda.core.managers.fields.Field#setValue(Object)
   * Field.setValue(...)} will throw an {@link IllegalArgumentException IllegalArgumentException}.
   *
   * @return {@link net.dv8tion.jda.core.managers.fields.AccountField AccountField} - Type: {@link
   ...
   * <b><u>Client Only</u></b>
   *
   * <p>An {@link net.dv8tion.jda.core.managers.fields.AccountField AccountField} for the {@code
   * email} of the currently logged in account.
   *
   * <p>To set the value use {@link net.dv8tion.jda.core.managers.fields.Field#setValue(Object)
   * setValue(String)} on the returned {@link net.dv8tion.jda.core.managers.fields.AccountField
   * AccountField} instance.
   *
   * <p>An email <b>must not</b> be {@code null} and must be valid according to {@link
   * #EMAIL_PATTERN}! <br>
   * Otherwise {@link net.dv8tion.jda.core.managers.fields.Field#setValue(Object)
   * Field.setValue(...)} will throw an {@link IllegalArgumentException IllegalArgumentException}.
   *
   ...
   *
   * <p>An {@link net.dv8tion.jda.core.managers.fields.AccountField AccountField} for the {@code
   * password} of the currently logged in account.
   *
   * <p>To set the value use {@link net.dv8tion.jda.core.managers.fields.Field#setValue(Object)
   * setValue(String)} on the returned {@link net.dv8tion.jda.core.managers.fields.AccountField
   * AccountField} instance.
   *
   * <p>A password <b>must not</b> be {@code null} or empty and must be in the range of 6-128
  ...
  /**
   * Resets all {@link net.dv8tion.jda.core.managers.fields.AccountField Fields} for this manager
   ...
   * apply <b>all</b> changes that have been made to this manager instance.
   *
   ...
   *       <br>
   *       If the specified {@code currentPassword} is not a valid password
   * </ul>
   *
   * @param currentPassword Used for accounts from {@link net.dv8tion.jda.core.AccountType#CLIENT
   *     AccountType.CLIENT}, provide {@code null} if this is not a client-account
   * @throws IllegalArgumentException If the provided password is null or empty and the currently
   *     logged in account is from {@link net.dv8tion.jda.core.AccountType#CLIENT
   *     AccountType.CLIENT}
   * @return {@link net.dv8tion.jda.core.requests.RestAction RestAction} <br>
  ...
  public RestAction<Void> update(String currentPassword) {
    ...
    if (name.shouldUpdate()) body.put("username", name.getValue());
   ...
   * @return {@link net.dv8tion.jda.core.requests.RestAction RestAction} - Type: Void Updates all
   *     modified fields or does nothing if none of the {@link
   *     net.dv8tion.jda.core.managers.fields.Field Fields} have been modified. ({@link
   *     net.dv8tion.jda.core.requests.RestAction.EmptyRestAction EmptyRestAction})
   */
  ...
  protected void setupFields() {
    name =
        new AccountField<String>(this, selfUser::getName) {
          @Override
          public void checkValue(String value) {
            Checks.notNull(value, "account name");
            if (value.length() < 2 || value.length() > 32)
              throw new IllegalArgumentException(
                  "Provided name must be 2 to 32 characters in length");
          }
        };

    avatar =
        new AccountField<Icon>(this, null) {
          @Override
          ...
          public Icon getOriginalValue() {
            throw new UnsupportedOperationException(
                "Cannot easily provide the original Avatar. Use User#getIconUrl() and download it yourself.");
          }
