...
/**
 * Facade for a {@link net.dv8tion.jda.core.managers.RoleManagerUpdatable RoleManagerUpdatable}
 * instance. <br>
...
public class RoleManager {
   ...
   * <br>
   * Wraps {@link RoleManagerUpdatable#getNameField()}
   *
   * <p>A role name <b>must not</b> be {@code null} nor less than 1 characters or more than 32
   * characters long!
   *
   ...
   * @throws IllegalArgumentException If the provided name is {@code null} or not between 1-32
   *     characters long
   * @return {@link net.dv8tion.jda.core.requests.restaction.AuditableRestAction
   *     AuditableRestAction} <br>
   *     Update RestAction from {@link RoleManagerUpdatable#update() #update()}
  ...
  /**
   * Sets the {@link net.dv8tion.jda.core.Permission Permissions} of the selected {@link
   * net.dv8tion.jda.core.entities.Role Role}. <br>
   * Wraps {@link net.dv8tion.jda.core.managers.fields.PermissionField#setValue(Long)
   * RoleManagerUpdatable#getPermissionField().setValue(Long)}
   *
   * <p>Permissions may only include already present Permissions for the currently logged in
   * account. <br>
   * You are unable to give permissions you don't have!
   *
   * @param perms The new raw permission value for the selected {@link
   *     net.dv8tion.jda.core.entities.Role Role}
   * @throws net.dv8tion.jda.core.exceptions.InsufficientPermissionException If the currently logged
   *     in account does not have the Permission {@link net.dv8tion.jda.core.Permission#MANAGE_ROLES
   *     MANAGE_ROLES} <br>
   *     or does not have permission to apply one of the specified permissions
   * @throws net.dv8tion.jda.core.exceptions.HierarchyException If the currently logged in account
   *     does not meet the required hierarchy position to {@link
   *     Role#canInteract(net.dv8tion.jda.core.entities.Role) interact} with this Role
   * @return {@link net.dv8tion.jda.core.requests.restaction.AuditableRestAction
   ...
   * Sets the {@link net.dv8tion.jda.core.Permission Permissions} of the selected {@link
   * net.dv8tion.jda.core.entities.Role Role}. <br>
   * Wraps {@link net.dv8tion.jda.core.managers.fields.PermissionField#setPermissions(Permission...)
   ...
   * You are unable to give permissions you don't have!
   *
   * @param permissions The new permission for the selected {@link
   *     net.dv8tion.jda.core.entities.Role Role}
   * @throws net.dv8tion.jda.core.exceptions.InsufficientPermissionException If the currently logged
   *     in account does not have the Permission {@link net.dv8tion.jda.core.Permission#MANAGE_ROLES
   *     MANAGE_ROLES} <br>
   ...
   * Sets the {@link net.dv8tion.jda.core.Permission Permissions} of the selected {@link
   * net.dv8tion.jda.core.entities.Role Role}. <br>
   * Wraps {@link net.dv8tion.jda.core.managers.fields.PermissionField#setPermissions(Collection)
  ...
  /**
   * Sets the {@link java.awt.Color Color} of the selected {@link net.dv8tion.jda.core.entities.Role
   * Role}. <br>
   * Wraps {@link RoleManagerUpdatable#getColorField()}
   *
  ...
  /**
   * Sets the <b><u>hoist state</u></b> of the selected {@link net.dv8tion.jda.core.entities.Role
   * Role}. <br>
   * Wraps {@link RoleManagerUpdatable#getHoistedField()}
   *
   * @param hoisted Whether the selected {@link net.dv8tion.jda.core.entities.Role Role} should be
   *     hoisted
   * @throws net.dv8tion.jda.core.exceptions.InsufficientPermissionException If the currently logged
   *     in account does not have the Permission {@link net.dv8tion.jda.core.Permission#MANAGE_ROLES
   *     MANAGE_ROLES}
  ...
  /**
   * Sets the <b><u>mentionable state</u></b> of the selected {@link
   * net.dv8tion.jda.core.entities.Role Role}. <br>
   * Wraps {@link RoleManagerUpdatable#getMentionableField()}
   *
   * @param mentionable Whether the selected {@link net.dv8tion.jda.core.entities.Role Role} should
   *     be mentionable
   * @throws net.dv8tion.jda.core.exceptions.InsufficientPermissionException If the currently logged
   *     in account does not have the Permission {@link net.dv8tion.jda.core.Permission#MANAGE_ROLES
   *     MANAGE_ROLES}
  ...
  /**
   * Adds the specified {@link net.dv8tion.jda.core.Permission Permissions} to the selected {@link
   * net.dv8tion.jda.core.entities.Role Role}. <br>
   * Wraps {@link
   * net.dv8tion.jda.core.managers.fields.PermissionField#givePermissions(Permission...)
   ...
   * You are unable to give permissions you don't have!
   *
   * @param perms The permission to give to the selected {@link net.dv8tion.jda.core.entities.Role
   *     Role}
   * @throws net.dv8tion.jda.core.exceptions.InsufficientPermissionException If the currently logged
   *     in account does not have the Permission {@link net.dv8tion.jda.core.Permission#MANAGE_ROLES
   *     MANAGE_ROLES} <br>
   ...
   * Adds the specified {@link net.dv8tion.jda.core.Permission Permissions} to the selected {@link
   * net.dv8tion.jda.core.entities.Role Role}. <br>
   * Wraps {@link net.dv8tion.jda.core.managers.fields.PermissionField#givePermissions(Collection)
  ...
  /**
   * Revokes the specified {@link net.dv8tion.jda.core.Permission Permissions} from the selected
   * {@link net.dv8tion.jda.core.entities.Role Role}. <br>
   * Wraps {@link
   * net.dv8tion.jda.core.managers.fields.PermissionField#revokePermissions(Permission...)
   ...
   *     in account does not have the Permission {@link net.dv8tion.jda.core.Permission#MANAGE_ROLES
   *     MANAGE_ROLES} <br>
   *     or does not have permission to revoke one of the specified permissions
   * @throws net.dv8tion.jda.core.exceptions.HierarchyException If the currently logged in account
   *     does not meet the required hierarchy position to {@link
   *     Role#canInteract(net.dv8tion.jda.core.entities.Role) interact} with this Role
   * @return {@link net.dv8tion.jda.core.requests.restaction.AuditableRestAction
   ...
   * Revokes the specified {@link net.dv8tion.jda.core.Permission Permissions} from the selected
   * {@link net.dv8tion.jda.core.entities.Role Role}. <br>
   * Wraps {@link net.dv8tion.jda.core.managers.fields.PermissionField#revokePermissions(Collection)
