...
/**
 * Facade for a {@link net.dv8tion.jda.core.managers.GuildManagerUpdatable GuildManagerUpdatable}
 * instance. <br>
...
public class GuildManager {
  ...
  /**
   * Sets the name of this {@link net.dv8tion.jda.core.entities.Guild Guild}. More information can
   * be found {@link GuildManagerUpdatable#getNameField() here}!
   *
   * <p>For information on possible {@link net.dv8tion.jda.core.requests.ErrorResponse
   * ErrorResponses} by the returned {@link net.dv8tion.jda.core.requests.RestAction RestAction} see
   * {@link GuildManagerUpdatable#update() #update()}
   *
   ...
   *     Update RestAction from {@link GuildManagerUpdatable#update() #update()}
  ...
  /**
   * Sets the {@link net.dv8tion.jda.core.Region Region} of this {@link
   * net.dv8tion.jda.core.entities.Guild Guild}. More information can be found {@link
   * GuildManagerUpdatable#getRegionField() here}!
   *
   * <p>For information on possible {@link net.dv8tion.jda.core.requests.ErrorResponse
   * ErrorResponses} by the returned {@link net.dv8tion.jda.core.requests.RestAction RestAction} see
   * {@link GuildManagerUpdatable#update() #update()}
   ...
   * @throws java.lang.IllegalArgumentException If the provided region is a {@link
   *     net.dv8tion.jda.core.Region#isVip() VIP Region} but the guild does not support VIP regions.
   *     Use {@link net.dv8tion.jda.core.entities.Guild#getFeatures() Guild#getFeatures()} to check
   *     if VIP regions are supported.
   * @return {@link net.dv8tion.jda.core.requests.restaction.AuditableRestAction
   *     AuditableRestAction} <br>
   *     Update RestAction from {@link GuildManagerUpdatable#update() #update()}
  ...
  /**
   * Sets the {@link net.dv8tion.jda.core.entities.Icon Icon} of this {@link
   * net.dv8tion.jda.core.entities.Guild Guild}. More information can be found {@link
   * GuildManagerUpdatable#getIconField() here}!
   *
   * <p>For information on possible {@link net.dv8tion.jda.core.requests.ErrorResponse
   * ErrorResponses} by the returned {@link net.dv8tion.jda.core.requests.RestAction RestAction} see
   * {@link GuildManagerUpdatable#update() #update()}
  ...
  /**
   * Sets the Splash {@link net.dv8tion.jda.core.entities.Icon Icon} of this {@link
   * net.dv8tion.jda.core.entities.Guild Guild}. More information can be found {@link
   * GuildManagerUpdatable#getSplashField() here}!
   *
   * <p>For information on possible {@link net.dv8tion.jda.core.requests.ErrorResponse
   * ErrorResponses} by the returned {@link net.dv8tion.jda.core.requests.RestAction RestAction} see
   * {@link GuildManagerUpdatable#update() #update()}
  ...
  /**
   * Sets the AFK {@link net.dv8tion.jda.core.entities.VoiceChannel VoiceChannel} of this {@link
   * net.dv8tion.jda.core.entities.Guild Guild}. More information can be found {@link
   * GuildManagerUpdatable#getAfkChannelField() here}!
   *
   * <p>For information on possible {@link net.dv8tion.jda.core.requests.ErrorResponse
   * ErrorResponses} by the returned {@link net.dv8tion.jda.core.requests.RestAction RestAction} see
   * {@link GuildManagerUpdatable#update() #update()}
   *
   * @param afkChannel The new afk channel for this {@link net.dv8tion.jda.core.entities.Guild
   *     Guild}
   * @return {@link net.dv8tion.jda.core.requests.restaction.AuditableRestAction
   *     AuditableRestAction} <br>
   *     Update RestAction from {@link GuildManagerUpdatable#update() #update()}
  ...
  /**
   * Sets the system {@link net.dv8tion.jda.core.entities.TextChannel TextChannel} of this {@link
   * net.dv8tion.jda.core.entities.Guild Guild}. More information can be found {@link
   * GuildManagerUpdatable#getSystemChannelField() here}!
   *
   * <p>For information on possible {@link net.dv8tion.jda.core.requests.ErrorResponse
   * ErrorResponses} by the returned {@link net.dv8tion.jda.core.requests.RestAction RestAction} see
   * {@link GuildManagerUpdatable#update() #update()}
   *
   * @param systemChannel The new system channel for this {@link net.dv8tion.jda.core.entities.Guild
   *     Guild}
   * @return {@link net.dv8tion.jda.core.requests.restaction.AuditableRestAction
   *     AuditableRestAction} <br>
   *     Update RestAction from {@link GuildManagerUpdatable#update() #update()}
  ...
  /**
   * Sets the afk {@link net.dv8tion.jda.core.entities.Guild.Timeout Timeout} of this {@link
   * net.dv8tion.jda.core.entities.Guild Guild}. More information can be found {@link
   * GuildManagerUpdatable#getAfkTimeoutField() here}!
   *
   * <p>For information on possible {@link net.dv8tion.jda.core.requests.ErrorResponse
   * ErrorResponses} by the returned {@link net.dv8tion.jda.core.requests.RestAction RestAction} see
   * {@link GuildManagerUpdatable#update() #update()}
  ...
  /**
   * Sets the {@link net.dv8tion.jda.core.entities.Guild.VerificationLevel Verification Level} of
   * this {@link net.dv8tion.jda.core.entities.Guild Guild}. More information can be found {@link
   * GuildManagerUpdatable#getVerificationLevelField() here}!
   *
   * <p>For information on possible {@link net.dv8tion.jda.core.requests.ErrorResponse
   * ErrorResponses} by the returned {@link net.dv8tion.jda.core.requests.RestAction RestAction} see
   * {@link GuildManagerUpdatable#update() #update()}
   *
   * @param level The new Verification Level for this {@link net.dv8tion.jda.core.entities.Guild
   *     Guild}
   * @return {@link net.dv8tion.jda.core.requests.restaction.AuditableRestAction
   *     AuditableRestAction} <br>
   *     Update RestAction from {@link GuildManagerUpdatable#update() #update()}
  ...
  /**
   * Sets the {@link net.dv8tion.jda.core.entities.Guild.NotificationLevel Notification Level} of
   * this {@link net.dv8tion.jda.core.entities.Guild Guild}. More information can be found {@link
   * GuildManagerUpdatable#getDefaultNotificationLevelField() here}!
   *
   * <p>For information on possible {@link net.dv8tion.jda.core.requests.ErrorResponse
   * ErrorResponses} by the returned {@link net.dv8tion.jda.core.requests.RestAction RestAction} see
   * {@link GuildManagerUpdatable#update() #update()}
   *
   * @param level The new Notification Level for this {@link net.dv8tion.jda.core.entities.Guild
   *     Guild}
   * @return {@link net.dv8tion.jda.core.requests.restaction.AuditableRestAction
   *     AuditableRestAction} <br>
   *     Update RestAction from {@link GuildManagerUpdatable#update() #update()}
  ...
  /**
   * Sets the {@link net.dv8tion.jda.core.entities.Guild.MFALevel MFA Level} of this {@link
   * net.dv8tion.jda.core.entities.Guild Guild}. More information can be found {@link
   * GuildManagerUpdatable#getRequiredMFALevelField() here}!
   *
   * <p>For information on possible {@link net.dv8tion.jda.core.requests.ErrorResponse
   * ErrorResponses} by the returned {@link net.dv8tion.jda.core.requests.RestAction RestAction} see
   * {@link GuildManagerUpdatable#update() #update()}
  ...
  /**
   * Sets the {@link net.dv8tion.jda.core.entities.Guild.ExplicitContentLevel Explicit Content
   * Level} of this {@link net.dv8tion.jda.core.entities.Guild Guild}. More information can be found
   * {@link net.dv8tion.jda.core.managers.GuildManagerUpdatable#getExplicitContentLevelField()
   * here}!
   *
   * <p>For information on possible {@link net.dv8tion.jda.core.requests.ErrorResponse
   * ErrorResponses} by the returned {@link net.dv8tion.jda.core.requests.RestAction RestAction} see
   ...
   *
   * @param level The new MFA Level for this {@link net.dv8tion.jda.core.entities.Guild Guild}
   * @throws java.lang.IllegalArgumentException If the provided level is {@code null} or {@link
   *     net.dv8tion.jda.core.entities.Guild.ExplicitContentLevel#UNKNOWN UNKNOWN}
   * @return {@link net.dv8tion.jda.core.requests.restaction.AuditableRestAction
   *     AuditableRestAction} <br>
   *     Update RestAction from {@link GuildManagerUpdatable#update() #update()}
   * @see net.dv8tion.jda.core.managers.GuildManagerUpdatable#getRequiredMFALevelField()
