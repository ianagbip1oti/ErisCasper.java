...
/**
 * Facade for a {@link net.dv8tion.jda.core.managers.PermOverrideManagerUpdatable
 * PermOverrideManagerUpdatable} instance. <br>
...
public class PermOverrideManager {
  ...
  /**
   * Grants the provided {@link net.dv8tion.jda.core.Permission Permissions} bits to the selected
   * {@link net.dv8tion.jda.core.entities.PermissionOverride PermissionOverridie}. <br>
   * Wraps {@link PermOverrideManagerUpdatable#grant(long)}
   *
   * @param permissions The permissions to grant to the selected {@link
   ...
   *     net.dv8tion.jda.core.Permission#MANAGE_PERMISSIONS MANAGE_PERMISSIONS}
   * @return {@link net.dv8tion.jda.core.requests.restaction.AuditableRestAction
   *     AuditableRestAction} <br>
   *     Update RestAction from {@link PermOverrideManagerUpdatable#update() #update()}
  ...
  /**
   * Grants the provided {@link net.dv8tion.jda.core.Permission Permissions} to the selected {@link
   * net.dv8tion.jda.core.entities.PermissionOverride PermissionOverridie}. <br>
   * Wraps {@link PermOverrideManagerUpdatable#grant(long)}
   *
   * @param permissions The permissions to grant to the selected {@link
   *     net.dv8tion.jda.core.entities.PermissionOverride PermissionOverride}
  ...
  /**
   * Denies the provided {@link net.dv8tion.jda.core.Permission Permissions} bits from the selected
   * {@link net.dv8tion.jda.core.entities.PermissionOverride PermissionOverridie}. <br>
   * Wraps {@link PermOverrideManagerUpdatable#deny(long)}
   *
   * @param permissions The permissions to deny from the selected {@link
   *     net.dv8tion.jda.core.entities.PermissionOverride PermissionOverride}
   * @throws net.dv8tion.jda.core.exceptions.InsufficientPermissionException If the currently logged
   *     in account does not have the Permission {@link
   *     net.dv8tion.jda.core.Permission#MANAGE_PERMISSIONS MANAGE_PERMISSIONS}
  ...
  /**
   * Denies the provided {@link net.dv8tion.jda.core.Permission Permissions} from the selected
   * {@link net.dv8tion.jda.core.entities.PermissionOverride PermissionOverridie}. <br>
   * Wraps {@link PermOverrideManagerUpdatable#deny(long)}
   *
   * @param permissions The permissions to deny from the selected {@link
  ...
  /**
   * Clears the provided {@link net.dv8tion.jda.core.Permission Permissions} bits from the selected
   * {@link net.dv8tion.jda.core.entities.PermissionOverride PermissionOverridie}. <br>
   * Wraps {@link PermOverrideManagerUpdatable#clear(long)} <br>
   * This will cause the provided Permissions to be inherited
   *
   * @param permissions The permissions to clear from the selected {@link
   *     net.dv8tion.jda.core.entities.PermissionOverride PermissionOverride}
   * @throws net.dv8tion.jda.core.exceptions.InsufficientPermissionException If the currently logged
   *     in account does not have the Permission {@link
   *     net.dv8tion.jda.core.Permission#MANAGE_PERMISSIONS MANAGE_PERMISSIONS}
