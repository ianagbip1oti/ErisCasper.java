...
/**
 * Specification AMF for an {@link net.dv8tion.jda.core.managers.AccountManagerUpdatable
 * AccountManagerUpdatable} field.
 *
 * <p><b>This class is abstract and requires an implementation for {@link #checkValue(Object)}</b>
 *
 * @param  <T> The Field-Type for this AccountField
 * @since 3.0
 */
