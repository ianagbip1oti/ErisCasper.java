...
/**
 * An {@link #update() updatable} manager that allows to modify {@link
 * net.dv8tion.jda.core.entities.PermissionOverride PermissionOverride} settings such as the granted
 * and denied {@link net.dv8tion.jda.core.Permission Permissions}.
 *
 ...
 *
 * <p>The {@link net.dv8tion.jda.core.managers.PermOverrideManager PermOverrideManager}
 ...
 * the Permission {@link net.dv8tion.jda.core.Permission#MANAGE_PERMISSIONS MANAGE_PERMISSIONS} in
 * the parent {@link net.dv8tion.jda.core.entities.Channel Channel}
 */
public class PermOverrideManagerUpdatable {
   ...
   *
   * @param override The {@link net.dv8tion.jda.core.entities.PermissionOverride PermissionOverride}
   *     to manage
   */
   ...
   * This is logically the same as calling {@code getPermissionOverride().getGuild()}
   *
  ...
  /**
   * The {@link net.dv8tion.jda.core.entities.Channel Channel} this Manager's {@link
   * net.dv8tion.jda.core.entities.PermissionOverride PermissionOverride} is in. <br>
   * This is logically the same as calling {@code getPermissionOverride().getChannel()}
   *
  ...
  /**
   * The target {@link net.dv8tion.jda.core.entities.PermissionOverride PermissionOverride} that
   * will be modified by this Manager
   *
  ...
  /**
   * Grants the specified permission bits to the target {@link
   * net.dv8tion.jda.core.entities.PermissionOverride}
   *
   * @param permissions Raw permission bits to grant
   * @throws net.dv8tion.jda.core.exceptions.InsufficientPermissionException If any of the provided
  ...
  /**
   * Grants the specified {@link net.dv8tion.jda.core.Permission Permissions} to the target {@link
   * net.dv8tion.jda.core.entities.PermissionOverride}
   *
  ...
  /**
   * Denies the specified permission bits from the target {@link
   * net.dv8tion.jda.core.entities.PermissionOverride}
   *
   * @param permissions Raw permission bits to deny
   * @throws net.dv8tion.jda.core.exceptions.InsufficientPermissionException If any of the provided
   *     permissions are not accessible
   * @return The current Manager instance for chaining convenience
   */
  ...
  /**
   * Denies the specified {@link net.dv8tion.jda.core.Permission Permissions} from the target {@link
   * net.dv8tion.jda.core.entities.PermissionOverride}
   *
  ...
  /**
   * Clears the specified permission bits from the target {@link
   * net.dv8tion.jda.core.entities.PermissionOverride} <br>
   * This will make the specified Permissions be inherited
   *
   * @param permission Raw permission bits to clear
   * @throws net.dv8tion.jda.core.exceptions.InsufficientPermissionException If any of the provided
   *     permissions are not accessible
   * @return The current Manager instance for chaining convenience
   */
  ...
  /**
   * Clears the specified {@link net.dv8tion.jda.core.Permission Permissions} from the target {@link
   * net.dv8tion.jda.core.entities.PermissionOverride} <br>
   * This will make the specified Permissions be inherited
   *
   * @param permissions Permissions to clear
   * @throws net.dv8tion.jda.core.exceptions.InsufficientPermissionException If any of the provided
   *     permissions are not accessible
   * @throws IllegalArgumentException If any of the provided permissions is {@code null}
   * @return The current Manager instance for chaining convenience
  ...
  /**
   * The granted {@link net.dv8tion.jda.core.Permission Permissions} value represented as raw long
   * bits. <br>
   * Use {@link Permission#getPermissions(long)} to retrieve a list of {@link
   * net.dv8tion.jda.core.Permission Permissions} from the returned bits.
   *
   * <p>This value represents all permissions that should be granted by this {@link
   * net.dv8tion.jda.core.entities.PermissionOverride PermissionOverride}
   *
   * @return Granted {@link net.dv8tion.jda.core.Permission Permissions} value or {@code null} if
   *     {@link #isSet()} is {@code false}
   */
  ...
  /**
   * The denied {@link net.dv8tion.jda.core.Permission Permissions} value represented as raw long
   * bits. <br>
   * Use {@link Permission#getPermissions(long)} to retrieve a list of {@link
   * net.dv8tion.jda.core.Permission Permissions} from the returned bits.
   *
   * <p>This value represents all permissions that should be denied by this {@link
   * net.dv8tion.jda.core.entities.PermissionOverride PermissionOverride}
   *
   * @return Denied {@link net.dv8tion.jda.core.Permission Permissions} value or {@code null} if
   *     {@link #isSet()} is {@code false}
   */
  ...
  /**
   * The inherited {@link net.dv8tion.jda.core.Permission Permissions} value represented as raw long
   * bits. <br>
   * Use {@link Permission#getPermissions(long)} to retrieve a list of {@link
   * net.dv8tion.jda.core.Permission Permissions} from the returned bits.
   *
   * <p>This value represents all permissions that are not granted or denied by the settings of this
   * Manager instance - thus they represent all permissions that are set to inherit from other
   * overrides.
   *
   * @return Inherited {@link net.dv8tion.jda.core.Permission Permissions} value or {@code null} if
   *     {@link #isSet()} is {@code false}
   */
  public Long getInheritBits() {
    ...
    for (Permission perm : Permission.values()) {
      if (perm.getOffset() > maxPerms) maxPerms = perm.getOffset();
    }
    maxPerms =
        ~(1
            << (maxPerms
                + 1)); // push 1 to max offset + 1, then flip to get a full-permission bit mask.
  ...
  /**
   * Resets all {@link net.dv8tion.jda.core.Permission Permission} values <br>
   ...
   *       <br>
   *       If the PermissionOverride was deleted before finishing the task
   ...
   *       net.dv8tion.jda.core.Permission#MANAGE_PERMISSIONS MANAGE_PERMISSIONS Permission}
   * </ul>
   *
   ...
   *     net.dv8tion.jda.core.Permission#MANAGE_PERMISSIONS MANAGE_PERMISSIONS} in the {@link
   *     #getChannel() Channel}
  ...
  public AuditableRestAction<Void> update() {
    ...
    if (!shouldUpdate()) return new AuditableRestAction.EmptyRestAction<>(getJDA(), null);
    ...
    Route.CompiledRoute route =
        Route.Channels.MODIFY_PERM_OVERRIDE.compile(override.getChannel().getId(), targetId);
