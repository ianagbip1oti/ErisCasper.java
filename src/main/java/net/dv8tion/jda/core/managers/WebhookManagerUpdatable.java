...
/**
 * An {@link #update() updatable} manager that allows to modify webhook settings like the {@link
 * #getNameField() default name} or the {@link #getAvatarField() default avatar}.
 *
 * <p>This manager allows to modify multiple fields at once by getting the {@link
 * net.dv8tion.jda.core.managers.fields.WebhookField WebhookField} for specific properties and
 ...
 * the Permission {@link net.dv8tion.jda.core.Permission#MANAGE_WEBHOOKS MANAGE_WEBHOOKS} in the
 * parent TextChannel
 */
public class WebhookManagerUpdatable {
   ...
   * net.dv8tion.jda.core.entities.Webhook Webhook} is in. <br>
   * This is logically the same as calling {@code getWebhook().getGuild()}
   *
  ...
  /**
   * The {@link net.dv8tion.jda.core.entities.TextChannel TextChannel} this Manager's {@link
   * net.dv8tion.jda.core.entities.Webhook Webhook} is in. <br>
  ...
  /**
   * The target {@link net.dv8tion.jda.core.entities.Webhook Webhook} that will be modified by this
   * manager
   *
  ...
  /**
   * A {@link net.dv8tion.jda.core.managers.fields.WebhookField WebhookField} for the
   * <b><u>name</u></b> of the selected {@link net.dv8tion.jda.core.entities.Webhook Webhook}'s
   * {@link Webhook#getDefaultUser() default User}. <br>
   * Default value: Not given
   *
   * <p>To set the value use {@link net.dv8tion.jda.core.managers.fields.Field#setValue(Object)
   * setValue(String)} on the returned {@link net.dv8tion.jda.core.managers.fields.WebhookField
   * WebhookField} instance.
   *
   * <p>A Webhook name <b>must bot</b> be {@code null}! <br>
   ...
   *
   * @return {@link net.dv8tion.jda.core.managers.fields.WebhookField WebhookField} - Type: {@code
   *     String}
   */
  ...
  /**
   * A {@link net.dv8tion.jda.core.managers.fields.WebhookField WebhookField} for the
   * <b><u>avatar</u></b> of the selected {@link net.dv8tion.jda.core.entities.Webhook Webhook}'s
   * {@link Webhook#getDefaultUser() default User}. <br>
   * Default value: {@code null}
   *
   * <p>To set the value use {@link net.dv8tion.jda.core.managers.fields.Field#setValue(Object)
   * setValue(Icon)} on the returned {@link net.dv8tion.jda.core.managers.fields.WebhookField
   * WebhookField} instance.
   *
   * @return {@link net.dv8tion.jda.core.managers.fields.WebhookField WebhookField} - Type: {@link
  ...
  /**
   * A {@link net.dv8tion.jda.core.managers.fields.WebhookField WebhookField} for the {@link
   * net.dv8tion.jda.core.entities.TextChannel TextChannel} of the selected {@link
   * net.dv8tion.jda.core.entities.Webhook Webhook}'s {@link Webhook#getDefaultUser() default User}.
   * <br>
   * Default value: Not given
   *
   * <p>To set the value use {@link net.dv8tion.jda.core.managers.fields.Field#setValue(Object)
   * setValue(TextChannel)} on the returned {@link net.dv8tion.jda.core.managers.fields.WebhookField
   * WebhookField} instance.
   *
   * <p>A Webhook channel <b>must bot</b> be {@code null} and <b>must</b> be from the same {@link
   ...
   *       If the TextChannel was deleted before finishing the task
   ...
   *       net.dv8tion.jda.core.Permission#MANAGE_WEBHOOKS MANAGE_WEBHOOKS Permission}
   * </ul>
   *
   ...
   *     net.dv8tion.jda.core.Permission#MANAGE_WEBHOOKS MANAGE_WEBHOOKS} in either the current or
   *     selected new TextChannel.
  ...
  public AuditableRestAction<Void> update() {
    ...
    if (channel.isSet() && !self.hasPermission(channel.getValue(), Permission.MANAGE_WEBHOOKS))
      throw new InsufficientPermissionException(
          Permission.MANAGE_WEBHOOKS, "Permission not available in selected new channel");
    if (!shouldUpdate()) return new AuditableRestAction.EmptyRestAction<>(getJDA(), null);

    JSONObject data = new JSONObject();
    data.put("name", name.getOriginalValue());

    if (channel.shouldUpdate()) data.put("channel_id", channel.getValue().getId());
    if (name.shouldUpdate()) data.put("name", name.getValue());
  ...
  protected boolean shouldUpdate() {
    return name.shouldUpdate() || avatar.shouldUpdate() || channel.shouldUpdate();
  }

  protected void setupFields() {
    name =
        new WebhookField<String>(this, webhook::getName) {
          @Override
    ...
    avatar =
        new WebhookField<Icon>(this, null) {
          @Override
    ...
    channel =
        new WebhookField<TextChannel>(this, webhook::getChannel) {
          @Override
          public void checkValue(TextChannel value) {
            Checks.notNull(value, "channel");
            Checks.check(
                value.getGuild().equals(getGuild()), "Channel is not from the same Guild!");
          }
        };
  }
}
