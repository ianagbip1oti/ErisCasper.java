 ...
 * Native Interface).
 *
 * <p><a href="http://adamheinrich.com/blog/2012/how-to-load-native-jni-library-from-jar">
...
public class NativeUtil {
   ...
   *
   * @param path The filename inside JAR as absolute path (beginning with '/'), e.g.
   *     /package/File.ext
