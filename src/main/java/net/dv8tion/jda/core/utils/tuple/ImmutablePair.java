 ...
 *
 * <p>Although the implementation is immutable, there is no restriction on the objects that may be
 * stored. If mutable objects are stored in the pair, then the pair itself effectively becomes
