...
/**
 * {@link net.dv8tion.jda.core.utils.cache.CacheView CacheView} implementation specifically to
 * combine {@link net.dv8tion.jda.core.entities.Member Member} cache views.
 *
 * <p>This is done because Members do not implement {@link net.dv8tion.jda.core.entities.ISnowflake
 * ISnowflake} as they are not globally unique but only unique per {@link
...
public interface UnifiedMemberCacheView extends CacheView<Member> {
   ...
   *
   * @param id The ID of the members
   * @throws java.lang.NumberFormatException If the provided String is {@code null} or cannot be
   *     resolved to an unsigned long id
   * @return Possibly-empty unmodifiable list of member for the specified ID
   */
  ...
  /**
   * Creates an immutable list of all members matching the given username. <br>
   ...
   * This will check the nickname of the member. If provided with {@code null} this will check for
   * members that have no nickname set.
   *
