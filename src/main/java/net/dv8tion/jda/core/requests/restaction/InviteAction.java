...
/**
 * {@link net.dv8tion.jda.core.entities.Invite Invite} Builder system created as an extension of
 * {@link net.dv8tion.jda.core.requests.RestAction} <br>
 * Provides an easy way to gather and deliver information to Discord to create {@link
 * net.dv8tion.jda.core.entities.Invite Invites}.
 */
public class InviteAction extends AuditableRestAction<Invite> {
  ...
  protected RequestBody finalizeData() {
    ...
    if (this.maxAge != null) object.put("max_age", (int) this.maxAge);
    if (this.maxUses != null) object.put("max_uses", (int) this.maxUses);
    if (this.temporary != null) object.put("temporary", (boolean) this.temporary);
    if (this.unique != null) object.put("unique", (boolean) this.unique);
  ...
  /**
   * Sets the max age in seconds for the invite. Set this to {@code 0} if the invite should never
   * expire. Default is {@code 86400} (24 hours). {@code null} will reset this to the default value.
   *
  ...
  /**
   * Sets the max age for the invite. Set this to {@code 0} if the invite should never expire.
   * Default is {@code 86400} (24 hours). {@code null} will reset this to the default value.
   *
   * @param maxAge The max age for this invite or {@code null} to use the default value.
   * @param timeUnit The {@link java.util.concurrent.TimeUnit TimeUnit} type of {@code maxAge}.
   * @throws IllegalArgumentException If maxAge is negative or maxAge is positive and timeUnit is
   *     null.
   * @return The current InviteAction for chaining.
   */
  @CheckReturnValue
  ...
  /**
   * Sets the max uses for the invite. Set this to {@code 0} if the invite should have unlimited
   * uses. Default is {@code 0}. {@code null} will reset this to the default value.
   *
   ...
   *
   * @param temporary Whether the invite should only grant temporary membership or {@code null} to
   ...
   *
   * @param unique Whether discord should reuse a similar invite or {@code null} to use the default
   *     value.
   * @return The current InviteAction for chaining.
   */
  @CheckReturnValue
