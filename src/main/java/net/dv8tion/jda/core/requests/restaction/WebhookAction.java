...
/**
 * {@link net.dv8tion.jda.core.entities.Webhook Webhook} Builder system created as an extension of
 ...
 * net.dv8tion.jda.core.entities.Webhook Webhooks}.
 */
public class WebhookAction extends AuditableRestAction<Webhook> {
  ...
  public WebhookAction setName(String name) {
    ...
    Checks.check(
        ...
        "The webhook name must be in the range of 2-100!");
   ...
   *
   * @param icon An {@link net.dv8tion.jda.core.entities.Icon Icon} for the new avatar. Or null to
   *     use default avatar.
   * @return The current WebhookAction for chaining convenience.
   */
