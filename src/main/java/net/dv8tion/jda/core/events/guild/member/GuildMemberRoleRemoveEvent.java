 ...
 * Fired if one or more {@link net.dv8tion.jda.core.entities.Role Roles} are removed from a {@link
...
public class GuildMemberRoleRemoveEvent extends GenericGuildMemberEvent {
  ...
  public GuildMemberRoleRemoveEvent(
      JDA api, long responseNumber, Guild guild, Member member, List<Role> removedRoles) {
