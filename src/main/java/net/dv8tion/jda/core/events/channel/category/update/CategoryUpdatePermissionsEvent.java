 ...
 *
 * <p>Fired when the permissions of a {@link net.dv8tion.jda.core.entities.Category Category} are
 * updated.
 *
...
public class CategoryUpdatePermissionsEvent extends GenericCategoryUpdateEvent {
  ...
  public CategoryUpdatePermissionsEvent(
      JDA api, long responseNumber, Category category, List<IPermissionHolder> changed) {
