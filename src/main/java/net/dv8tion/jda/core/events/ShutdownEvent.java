...
public class ShutdownEvent extends Event {
   ...
   *
   * @return {@link java.time.OffsetDateTime OffsetDateTime} representing the point in time when the
   ...
   * meaning for this ShutdownEvent. <br>
   * The raw close code can be retrieved from {@link #getCode()} <br>
   * If this is {@code null}, JDA does not know what the meaning for the connection loss was.
   *
