 ...
 * Fired if a Message is received in a {@link net.dv8tion.jda.core.entities.MessageChannel
 * MessageChannel}. <br>
 * This includes {@link net.dv8tion.jda.core.entities.TextChannel TextChannel}, {@link
 * net.dv8tion.jda.core.entities.PrivateChannel PrivateChannel} and {@link
 * net.dv8tion.jda.client.entities.Group Group}!
 *
 * <p>Use: This event indicates that a Message is received in either a guild, private channel or
 * group. Providing a MessageChannel and Message.
 */
public class MessageReceivedEvent extends GenericMessageEvent {
   ...
   * Member} object. <br>
   * This will be {@code null} in case of Message being received in a {@link
   * net.dv8tion.jda.core.entities.PrivateChannel PrivateChannel}, a {@link
   * net.dv8tion.jda.client.entities.Group Group} or {@link #isWebhookMessage() isWebhookMessage()}
   * returning {@code true}.
   *
  ...
  /**
   * Returns the {@link net.dv8tion.jda.core.entities.PrivateChannel PrivateChannel} the Message was
   * received in. <br>
   * If this Message was not received in a {@link net.dv8tion.jda.core.entities.PrivateChannel
   * PrivateChannel}, this will return {@code null}.
   *
   ...
   * <br>
   * If this Message was not received in a {@link net.dv8tion.jda.client.entities.Group Group}, this
  ...
  /**
   * Returns the {@link net.dv8tion.jda.core.entities.TextChannel TextChannel} the Message was
   * received in. <br>
   * If this Message was not received in a {@link net.dv8tion.jda.core.entities.TextChannel
   * TextChannel}, this will return {@code null}.
   *
  ...
  /**
   * Returns the {@link net.dv8tion.jda.core.entities.Guild Guild} the Message was received in. <br>
   * If this Message was not received in a {@link net.dv8tion.jda.core.entities.TextChannel
   * TextChannel}, this will return {@code null}.
   *
