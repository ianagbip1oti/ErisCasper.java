 ...
 * Fired if a {@link net.dv8tion.jda.core.entities.User User} is banned from a {@link
 * net.dv8tion.jda.core.entities.Guild Guild}.<br>
 * <br>
 * Use: Retrieve the user who was banned (if available) and triggering guild.
 *
 * <p><b>Note</b>: This does not directly indicate that a Member is removed from the Guild!
 */
