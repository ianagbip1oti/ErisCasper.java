 ...
 * <br>
 * Use: Get affected VoiceChannel, affected Guild and affected {@link
...
public class VoiceChannelUpdatePermissionsEvent extends GenericVoiceChannelUpdateEvent {
  ...
  public VoiceChannelUpdatePermissionsEvent(
      JDA api, long responseNumber, VoiceChannel channel, List<IPermissionHolder> changed) {
