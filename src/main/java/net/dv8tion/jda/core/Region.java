...
/**
 * Represents the Regions used for Audio connections. <br>
 * This is used by {@link net.dv8tion.jda.core.entities.Guild Guild} to where the server that hosts
 * the {@link net.dv8tion.jda.core.entities.Guild Guild} is located.
 */
public enum Region {
  ...
  /**
   * Whether or not this Region is a VIP region. <br>
   * VIP regions have special perks like higher bitrate in VoiceChannels and priority during times
   ...
   *
   * @param key The key relating to the {@link net.dv8tion.jda.core.Region Region} we wish to
   *     retrieve.
