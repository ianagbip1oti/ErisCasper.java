...
public class ContextException extends Exception {
   ...
   * {@link Throwable#printStackTrace()}. <br>
   * Equivalent to {@code here(Throwable::printStackTrace)}
   *
  ...
  /**
   * Creates a wrapping {@link java.util.function.Consumer Consumer} for the provided target.
   *
