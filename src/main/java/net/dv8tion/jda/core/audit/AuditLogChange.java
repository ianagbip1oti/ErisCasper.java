...
/**
 * Plain-Old-Java-Object (POJO) representing a single change for an {@link
 * net.dv8tion.jda.core.audit.AuditLogEntry AuditLogEntry}! <br>
 * This object holds the {@link #getOldValue() old-} and {@link #getNewValue() new value} for the
...
public class AuditLogChange {
   ...
   *
   * @param  <T> The expected generic type for this value. <br>
