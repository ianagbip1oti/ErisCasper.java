...
/**
 * WebSocket OP Codes for discord <br>
 * Used in {@link net.dv8tion.jda.core.requests.WebSocketClient WebSocketClient} to handle discord
 * payloads and send payloads with central readable OP Codes
 */
