...
public enum EmbedType {
   ...
   * If the provided key doesn't match any known {@link net.dv8tion.jda.core.entities.EmbedType
   * EmbedType}, this will return {@link net.dv8tion.jda.core.entities.EmbedType#UNKNOWN UNKNOWN}.
   *
   * @param key The key related to the {@link net.dv8tion.jda.core.entities.EmbedType EmbedType}.
   * @return The {@link net.dv8tion.jda.core.entities.EmbedType EmbedType} matching the provided
   *     key, or {@link net.dv8tion.jda.core.entities.EmbedType#UNKNOWN UNKNOWN}.
   */
