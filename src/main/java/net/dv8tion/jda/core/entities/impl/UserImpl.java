...
public class UserImpl implements User {
  ...
  public RestAction<PrivateChannel> openPrivateChannel() {
    if (privateChannel != null) return new RestAction.EmptyRestAction<>(getJDA(), privateChannel);

    if (fake) throw new IllegalStateException("Cannot open a PrivateChannel with a Fake user.");
  ...
  public PrivateChannel getPrivateChannel() {
    if (!hasPrivateChannel())
      throw new IllegalStateException(
          "There is no PrivateChannel for this user yet! Use User#openPrivateChannel() first!");
  ...
  public void formatTo(Formatter formatter, int flags, int width, int precision) {
    ...
    else if (upper) out = String.format(formatter.locale(), "%S#%s", getName(), getDiscriminator());
    else out = String.format(formatter.locale(), "%s#%s", getName(), getDiscriminator());
