...
public class VoiceChannelImpl extends AbstractChannelImpl<VoiceChannelImpl>
  ...
  public int getPosition() {
    ...
    throw new AssertionError(
        "Somehow when determining position we never found the VoiceChannel in the Guild's channels? wtf?");
  }
  ...
  public ChannelAction createCopy(Guild guild) {
    ...
    ChannelAction action =
        guild.getController().createVoiceChannel(name).setBitrate(bitrate).setUserlimit(userLimit);
  ...
  public boolean equals(Object o) {
    if (!(o instanceof VoiceChannel)) return false;
  ...
  public int compareTo(VoiceChannel chan) {
    ...
    Checks.check(
        ...
        "Cannot compare VoiceChannels that aren't from the same guild!");
