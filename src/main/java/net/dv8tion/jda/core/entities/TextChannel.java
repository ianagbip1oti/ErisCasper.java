 ...
 *
 * <p>Internal implementation of this class is available at {@link
 * net.dv8tion.jda.core.entities.impl.TextChannelImpl TextChannelImpl}. <br>
 * Note: Internal implementation should not be used directly.
 */
public interface TextChannel
    extends Channel, MessageChannel, Comparable<TextChannel>, IMentionable {
  /**
   * The topic set for this TextChannel. <br>
  ...
  /**
   * Whether or not this channel is considered as "NSFW" (Not-Safe-For-Work) <br>
   * This will check whether the name of this TextChannel begins with {@code nsfw-} or is equal to
   * {@code nsfw}!
   *
  ...
  /**
   * Retrieves the {@link net.dv8tion.jda.core.entities.Webhook Webhooks} attached to this
   * TextChannel.
   *
   ...
   * </ul>
   *
   * @return {@link net.dv8tion.jda.core.requests.RestAction} - Type: List{@literal <}{@link
   ...
   * @throws net.dv8tion.jda.core.exceptions.PermissionException If you do not hold the permission
   *     {@link net.dv8tion.jda.core.Permission#MANAGE_WEBHOOKS Manage Webhooks}
   * @throws IllegalArgumentException If the provided name is {@code null}, blank or not between
  ...
  /**
   * Bulk deletes a list of messages. <b>This is not the same as calling {@link
   * net.dv8tion.jda.core.entities.Message#delete()} in a loop.</b> <br>
   * This is much more efficient, but it has a different ratelimit. You may call this once per
   * second per Guild.
   *
   * <p>Must be at least 2 messages and not be more than 100 messages at a time. <br>
   * If you only have 1 message, use the {@link Message#delete()} method instead. <br>
   *
   * <p>You must have the Permission {@link net.dv8tion.jda.core.Permission#MESSAGE_MANAGE
   * MESSAGE_MANAGE} in this channel to use this function.
   *
   * <p>This method is best used when using {@link MessageHistory MessageHistory} to delete a large
   * amount of messages. If you have a large amount of messages but only their message Ids, please
   * use {@link #deleteMessagesByIds(Collection)}
   *
   * <p>Possible ErrorResponses include:
   *
   * <ul>
   ...
   * @throws net.dv8tion.jda.core.exceptions.InsufficientPermissionException If this account does
   *     not have {@link net.dv8tion.jda.core.Permission#MESSAGE_MANAGE Permission.MESSAGE_MANAGE}
  ...
  /**
   * Bulk deletes a list of messages. <b>This is not the same as calling {@link
   * net.dv8tion.jda.core.entities.MessageChannel#deleteMessageById(String)} in a loop.</b> <br>
   * This is much more efficient, but it has a different ratelimit. You may call this once per
   * second per Guild.
   *
   * <p>Must be at least 2 messages and not be more than 100 messages at a time. <br>
   * If you only have 1 message, use the {@link net.dv8tion.jda.core.entities.Message#delete()}
   * method instead. <br>
   *
   * <p>You must have {@link net.dv8tion.jda.core.Permission#MESSAGE_MANAGE
   * Permission.MESSAGE_MANAGE} in this channel to use this function.
   *
   * <p>This method is best used when you have a large amount of messages but only their message
   * Ids. If you are using {@link MessageHistory MessageHistory} or have {@link
   * net.dv8tion.jda.core.entities.Message Message} objects, it would be easier to use {@link
   * #deleteMessages(java.util.Collection)}.
   *
   * <p>Possible ErrorResponses include:
   *
   * <ul>
   ...
   * @throws java.lang.IllegalArgumentException If the size of the list less than 2 or more than 100
   *     messages.
   * @throws java.lang.NumberFormatException If any of the provided ids cannot be parsed by {@link
  ...
  /**
   * Deletes a {@link net.dv8tion.jda.core.entities.Webhook Webhook} attached to this channel by the
   * {@code id} specified.
   *
   * <p>Possible ErrorResponses include:
   *
   * <ul>
   *   <li>{@link net.dv8tion.jda.core.requests.ErrorResponse#UNKNOWN_WEBHOOK} <br>
   *       The provided id does not refer to a WebHook present in this TextChannel, either due to it
   *       not existing or having already been deleted.
   *   <li>{@link net.dv8tion.jda.core.requests.ErrorResponse#UNKNOWN_CHANNEL UNKNOWN_CHANNEL} <br>
   *       if this channel was deleted
   *   <li>{@link net.dv8tion.jda.core.requests.ErrorResponse#MISSING_ACCESS MISSING_ACCESS} <br>
   *       if we were removed from the guild
   ...
   *       MISSING_PERMISSIONS} <br>
   *       The send request was attempted after the account lost {@link
   *       net.dv8tion.jda.core.Permission#MANAGE_WEBHOOKS Permission.MANAGE_WEBHOOKS} in the
   *       channel.
   * </ul>
   *
   ...
   *     in account does not have {@link net.dv8tion.jda.core.Permission#MANAGE_WEBHOOKS
   *     Permission.MANAGE_WEBHOOKS} in this channel.
   * @return {@link net.dv8tion.jda.core.requests.restaction.AuditableRestAction
   *     AuditableRestAction}
   */
  ...
  /**
   * Attempts to remove all reactions from a message with the specified {@code messageId} in this
   * TextChannel <br>
   ...
   * @throws net.dv8tion.jda.core.exceptions.InsufficientPermissionException If the currently logged
   *     in account does not have {@link net.dv8tion.jda.core.Permission#MESSAGE_MANAGE
  ...
  /**
   * Whether we can send messages in this channel. <br>
   * This is an overload of {@link #canTalk(Member)} with the SelfMember. <br>
   * Checks for both {@link net.dv8tion.jda.core.Permission#MESSAGE_READ Permission.MESSAGE_READ}
   * and {@link net.dv8tion.jda.core.Permission#MESSAGE_WRITE Permission.MESSAGE_WRITE}.
   *
  ...
  /**
   * Whether the specified {@link net.dv8tion.jda.core.entities.Member} can send messages in this
   * channel. <br>
   * Checks for both {@link net.dv8tion.jda.core.Permission#MESSAGE_READ Permission.MESSAGE_READ}
   * and {@link net.dv8tion.jda.core.Permission#MESSAGE_WRITE Permission.MESSAGE_WRITE}.
   *
