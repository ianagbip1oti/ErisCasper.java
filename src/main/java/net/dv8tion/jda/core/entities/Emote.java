 ...
 *
 * <p><b>This does not represent unicode emojis like they are used in the official client! (:smiley:
 * is not a custom emoji)</b>
 *
 * @since 2.2
...
public interface Emote extends ISnowflake, IMentionable, IFakeable {
  ...
  /**
   * Roles this emote is active for <br>
   * <a href="https://discordapp.com/developers/docs/resources/guild#emoji-object"
  ...
  /**
   * Whether this emote is managed. A managed Emote is controlled by Discord, not the Guild
   * administrator, typical via a service like BBTV in conjunction with Twitch. <br>
   * <a href="https://discordapp.com/developers/docs/resources/guild#emoji-object"
   * target="_blank">Learn More</a>
   *
   ...
   *
   * <ul>
   *   <li>{@link net.dv8tion.jda.core.requests.ErrorResponse#UNKNOWN_EMOJI UNKNOWN_EMOTE} <br>
   *       If this Emote was already removed
   *   <li>{@link net.dv8tion.jda.core.requests.ErrorResponse#UNKNOWN_GUILD UNKNOWN_GUILD} <br>
   *       If the Guild of this Emote was deleted
   *   <li>{@link net.dv8tion.jda.core.requests.ErrorResponse#MISSING_ACCESS MISSING_ACCESS} <br>
   *       If we were removed from the Guild
   * </ul>
   *
   * @throws IllegalStateException if this Emote is fake ({@link #isFake()})
   * @throws java.lang.UnsupportedOperationException If this emote is managed by discord ({@link
   *     #isManaged()})
   * @throws net.dv8tion.jda.core.exceptions.InsufficientPermissionException if the Permission
   *     {@link net.dv8tion.jda.core.Permission#MANAGE_EMOTES MANAGE_EMOTES} is not given
  ...
  /**
   * An <b>updatable</b> manager for this Emote, used to modify properties of the emote like name
   * and role restrictions.
   *
   * <p>This will only work for the client account type.
   *
   * <p>This specific Manager is used to modify multiple properties at once by setting the property
   * and calling {@link EmoteManagerUpdatable#update()}
   *
   * @throws IllegalStateException if this emote is fake
  ...
  /**
   * A String representation of the URL which leads to image displayed within the official
   * Discord&trade; client when this Emote is used
   *
  ...
  /**
   * Usable representation of this Emote (used to display in the client just like mentions with a
   * specific format) <br>
   * Emotes are used with the format <code>
   * &lt;:{@link #getName getName()}:{@link #getId getId()}&gt;</code>
   *
   * @return A usable String representation for this Emote
   * @see <a
   *     href="https://discordapp.com/developers/docs/resources/channel#message-formatting">Message
   *     Formatting</a>
   */
  @Override
   ...
   * <br>
   * Same logic as {@link #canInteract(User, MessageChannel, boolean) canInteract(issuer, channel,
   * true)}!
   *
   * @param issuer The User to test
   ...
   * Whether the specified Member can interact with this Emote within the provided MessageChannel
   * <br>
   * Special override to exclude elevated bot permissions in case of (for instance) reacting to
   * messages.
   *
   * @param issuer The User to test
   * @param channel The MessageChannel to test
