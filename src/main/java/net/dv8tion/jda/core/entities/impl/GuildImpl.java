...
public class GuildImpl implements Guild {
  ...
  private final SortedSnowflakeCacheView<Category> categoryCache =
      new SortedSnowflakeCacheView<Category>(Channel::getName, Comparator.naturalOrder());
  private final SortedSnowflakeCacheView<VoiceChannel> voiceChannelCache =
      new SortedSnowflakeCacheView<VoiceChannel>(Channel::getName, Comparator.naturalOrder());
  private final SortedSnowflakeCacheView<TextChannel> textChannelCache =
      new SortedSnowflakeCacheView<TextChannel>(Channel::getName, Comparator.naturalOrder());
  private final SortedSnowflakeCacheView<Role> roleCache =
      new SortedSnowflakeCacheView<Role>(Role::getName, Comparator.reverseOrder());
  private final SnowflakeCacheViewImpl<Emote> emoteCache =
      new SnowflakeCacheViewImpl<>(Emote::getName);
  ...
  public String getSplashUrl() {
    return splashId == null
        ? null
        : "https://cdn.discordapp.com/splashes/" + id + "/" + splashId + ".jpg";
  }
  ...
  public RestAction<Integer> getPrunableMemberCount(int days) {
    ...
    if (days < 1) throw new IllegalArgumentException("Days amount must be at minimum 1 day.");
  ...
  public GuildManager getManager() {
    ...
    if (mng == null) {
      synchronized (mngLock) {
        mng = manager;
        if (mng == null) mng = manager = new GuildManager(this);
      }
    }
    return mng;
  }
  ...
  public GuildManagerUpdatable getManagerUpdatable() {
    ...
    if (mng == null) {
      synchronized (mngLock) {
        ...
        if (mng == null) mng = managerUpdatable = new GuildManagerUpdatable(this);
      }
    }
    return mng;
  }
  ...
  public GuildController getController() {
    ...
    if (ctrl == null) {
      synchronized (mngLock) {
        ctrl = controller;
        if (ctrl == null) ctrl = controller = new GuildController(this);
      }
    }
    return ctrl;
  }
  ...
  public RestAction<Void> leave() {
    if (owner.equals(getSelfMember()))
      throw new IllegalStateException(
          "Cannot leave a guild that you are the owner of! Transfer guild ownership first!");
  ...
  public RestAction<Void> delete() {
    if (api.getSelfUser().isMfaEnabled())
      throw new IllegalStateException(
          "Cannot delete a guild without providing MFA code. Use Guild#delete(String)");
