...
/**
 * Represents a Discord User. Contains all publicly available information about a specific Discord
 * User.
 *
 * <h1>Formattable</h1>
 *
 ...
 *
 * <p>This will use {@link #getAsMention()} rather than {@link Object#toString()}! <br>
 * Supported Features:
 *
 * <ul>
 *   <li><b>Alternative</b> <br>
 *       - Uses the <u>Discord Tag</u> (Username#Discriminator) instead (Example: {@code %#s} -
 *       results in <code>{@link User#getName()}#{@link User#getDiscriminator()}
 *              {@literal ->} Minn#6688</code>)
...
public interface User extends ISnowflake, IMentionable, IFakeable {
  ...
  /**
   * The username of the {@link net.dv8tion.jda.core.entities.User User}. Length is between 2 and 32
   * characters (inclusive).
   *
   * @return Never-null String containing the {@link net.dv8tion.jda.core.entities.User User}'s
   *     username.
   */
  String getName();
  ...
  /**
   * <br>
   * The discriminator of the {@link net.dv8tion.jda.core.entities.User User}. Used to differentiate
   * between users with the same usernames. <br>
  ...
  /**
   * The Discord Id for this user's avatar image. If the user has not set an image, this will return
   * null.
   *
   * @return Possibly-null String containing the {@link net.dv8tion.jda.core.entities.User User}
   *     avatar id.
   */
  String getAvatarId();
   ...
   * <br>
   * If a channel has already been opened with this user, it is immediately returned in the
   * RestAction's success consumer without contacting the Discord API.
   *
   ...
   * </ul>
   *
   * @throws java.lang.UnsupportedOperationException If the recipient User is the currently logged
   *     in account (represented by {@link net.dv8tion.jda.core.entities.SelfUser SelfUser})
  ...
  /**
   * Finds and collects all {@link net.dv8tion.jda.core.entities.Guild Guild} instances that contain
   * this {@link net.dv8tion.jda.core.entities.User User} within the current {@link
   * net.dv8tion.jda.core.JDA JDA} instance.<br>
   *
   * <p>This method is a shortcut for {@link net.dv8tion.jda.core.JDA#getMutualGuilds(User...)
   * JDA.getMutualGuilds(User)}.
   *
   * @return Unmodifiable list of all {@link net.dv8tion.jda.core.entities.Guild Guilds} that this
   *     user is a member of.
   */
  List<Guild> getMutualGuilds();

  /**
   * Returns whether or not the given user is a Bot-Account (special badge in client, some different
   * behaviour)
   *
