...
public interface Invite {
  /**
   * Retrieves a new {@link net.dv8tion.jda.core.entities.Invite Invite} instance for the given
   * invite code. <br>
   * <b>You cannot resolve invites if you were banned from the origin Guild!</b>
   *
   ...
   *     net.dv8tion.jda.core.entities.Invite Invite} <br>
   *     The Invite object
   */
  ...
  /**
   * Deletes this invite. <br>
   * Requires {@link net.dv8tion.jda.core.Permission#MANAGE_CHANNEL MANAGE_CHANNEL} in the invite's
   * channel. Will throw a {@link net.dv8tion.jda.core.exceptions.InsufficientPermissionException
   ...
   *     have {@link net.dv8tion.jda.core.Permission#MANAGE_SERVER MANAGE_SERVER} in the invite's
   *     channel
  ...
  /**
   * Tries to retrieve a new expanded {@link net.dv8tion.jda.core.entities.Invite Invite} with more
   * info. <br>
   * Requires either {@link net.dv8tion.jda.core.Permission#MANAGE_SERVER MANAGE_SERVER} in the
   * invite's guild or {@link net.dv8tion.jda.core.Permission#MANAGE_CHANNEL MANAGE_CHANNEL} in the
   * invite's channel. Will throw a {@link
   * net.dv8tion.jda.core.exceptions.InsufficientPermissionException
   * InsufficientPermissionException} otherwise.
   *
   * @throws net.dv8tion.jda.core.exceptions.InsufficientPermissionException if the account neither
   *     has {@link net.dv8tion.jda.core.Permission#MANAGE_SERVER MANAGE_SERVER} in the invite's
   *     guild nor {@link net.dv8tion.jda.core.Permission#MANAGE_CHANNEL MANAGE_CHANNEL} in the
   *     invite's channel
   * @return {@link net.dv8tion.jda.core.requests.RestAction RestAction} - Type: {@link
   *     net.dv8tion.jda.core.entities.Invite Invite} <br>
  ...
  /**
   * An {@link net.dv8tion.jda.core.entities.Invite.Channel Invite.Channel} object containing
   * information about this invite's origin channel.
   *
  ...
  /**
   * The invite URL for this invite in the format of: {@code "https://discord.gg/" + getCode()}
   *
   ...
   *
   * <p>This works only for expanded invites and will throw a {@link IllegalStateException}
   * otherwise!
   *
  ...
  /**
   * An {@link net.dv8tion.jda.core.entities.Invite.Guild Invite.Guild} object containing
   * information about this invite's origin guild.
   *
  ...
  /**
   * The user who created this invite. This may be a fake user. For not expanded invites this may be
   * null.
   *
  ...
  /**
   * Whether this Invite is expanded or not. Expanded invites contain more information, but they can
   * only be obtained be {@link net.dv8tion.jda.core.entities.Guild#getInvites() Guild#getInvites()}
   * (requires {@link net.dv8tion.jda.core.Permission#MANAGE_CHANNEL Permission.MANAGE_CHANNEL}) or
   ...
   *
   * <p>There is a convenience method {@link #expand()} to get the expanded invite for an unexpanded
   * one.
   *
  ...
  interface Channel extends ISnowflake {
    ...
    /**
     * The {@link net.dv8tion.jda.core.entities.ChannelType ChannelType} of this channel. <br>
     * Valid values are only {@link net.dv8tion.jda.core.entities.ChannelType#TEXT TEXT} or {@link
