...
public enum ChannelType {
  ...
  VOICE(2, true),
  /**
   * A {@link net.dv8tion.jda.client.entities.Group Group}. {@link
   * net.dv8tion.jda.core.AccountType#CLIENT AccountType.CLIENT} only.
   */
  GROUP(3),
  /** A {@link net.dv8tion.jda.core.entities.Category Category}, Guild-Only. */
  CATEGORY(4, true),
  /**
   * Unknown Discord channel type. Should never happen and would only possibly happen if Discord
   * implemented a new channel type and JDA had yet to implement support for it.
   */
  UNKNOWN(-1);
  ...
  /**
   * Whether this ChannelType is present for a Guild {@link net.dv8tion.jda.core.entities.Channel
   * Channel}
   *
   ...
   * @return The ChannelType that is referred to by the provided key. If the id key is unknown,
