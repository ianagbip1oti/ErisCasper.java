...
public interface SelfUser extends User {
   ...
   * <b>NOTE:</b> this is a {@link net.dv8tion.jda.core.AccountType#CLIENT AccountType.CLIENT}
   * method only!
   *
   * @throws AccountTypeException If this method is called when {@link
   *     net.dv8tion.jda.core.JDA#getAccountType() JDA#getAccountType()} does not return {@link
   *     net.dv8tion.jda.core.AccountType#CLIENT AccountType.CLIENT}. E.g: If the logged in account
   *     isn't a Client account!
   * @return The email of the currently logged in account.
   */
  String getEmail() throws AccountTypeException;

  /**
   * Shows whether there has ever been a mobile app connected to this account. <br>
   * <b>NOTE:</b> this is a {@link net.dv8tion.jda.core.AccountType#CLIENT AccountType.CLIENT}
   * method only!
   *
   * @throws AccountTypeException If this method is called when {@link
  ...
  /**
   * The Discord Nitro status of this account. <br>
   * <b>NOTE:</b> this is a {@link net.dv8tion.jda.core.AccountType#CLIENT AccountType.CLIENT}
   * method only!
   *
   * @throws AccountTypeException If this method is called when {@link
  ...
  /**
   * Used to get the phone number of the currently logged in account if a phone number has been
   * attached to it. <br>
   * <b>NOTE:</b> this is a {@link net.dv8tion.jda.core.AccountType#CLIENT AccountType.CLIENT}
   * method only!
   *
   ...
   * Returns {@value net.dv8tion.jda.core.entities.Message#MAX_FILE_SIZE} for bots and non-nitro
   * client accounts and {@value net.dv8tion.jda.core.entities.Message#MAX_FILE_SIZE_NITRO} for
   * client accounts with a active nitro subscription.
   *
  ...
  /**
   * The {@link net.dv8tion.jda.core.managers.AccountManager AccountManager} for the currently
   * logged in account.
   *
  ...
  /**
   * The {@link net.dv8tion.jda.core.managers.AccountManagerUpdatable AccountManagerUpdatable} for
