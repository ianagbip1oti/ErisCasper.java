...
public interface IPermissionHolder {
  ...
  /**
   * Checks whether or not this PermissionHolder has the given {@link
   * net.dv8tion.jda.core.Permission Permissions} in the Guild.
   *
  ...
  /**
   * Checks whether or not this PermissionHolder has the {@link net.dv8tion.jda.core.Permission
   * Permissions} in the provided {@code Collection<Permission>} in the Guild.
   *
   * @param permissions Permissions to check for.
   * @return True, if all of the specified Permissions are granted to this PermissionHolder.
   */
  ...
  /**
   * Checks whether or not this PermissionHolder has the given {@link
   * net.dv8tion.jda.core.Permission Permissions} in the specified Channel.
   *
   * @param channel The {@link net.dv8tion.jda.core.entities.Channel Channel} in which to check.
   * @param permissions Permissions to check for.
   * @return True, if all of the specified Permissions are granted to this PermissionHolder in the
   *     provided Channel.
   */
  ...
  /**
   * Checks whether or not this PermissionHolder has the {@link net.dv8tion.jda.core.Permission
   * Permissions} in the provided {@code Collection<Permission>} in the specified Channel.
   *
   * @param channel The {@link net.dv8tion.jda.core.entities.Channel Channel} in which to check.
   * @param permissions Permissions to check for.
   * @return True, if all of the specified Permissions are granted to this PermissionHolder in the
