 ...
 * Used to represent various base64 images in the Discord api. <br>
 * Example: {@link net.dv8tion.jda.core.managers.AccountManager#setAvatar(Icon)}.
 *
 * @since 3.0
 */
public class Icon {
   ...
   * We here read the specified InputStream and forward the retrieved byte data to {@link
   * #from(byte[])}.
   *
