...
/**
 * Represents a {@link net.dv8tion.jda.core.entities.Guild Guild}'s Role. Used to control
 * permissions for Members.
 */
public interface Role extends ISnowflake, IMentionable, IPermissionHolder, Comparable<Role> {
  /**
   * The hierarchical position of this {@link net.dv8tion.jda.core.entities.Role Role} in the {@link
   * net.dv8tion.jda.core.entities.Guild Guild} hierarchy. (higher value means higher role). <br>
   * The {@link net.dv8tion.jda.core.entities.Guild#getPublicRole()}'s getPosition() always return
   * -1.
   *
  ...
  /**
   * The actual position of the {@link net.dv8tion.jda.core.entities.Role Role} as stored and given
   * by Discord. <br>
   * Role positions are actually based on a pairing of the creation time (as stored in the snowflake
   * id) and the position. If 2 or more roles share the same position then they are sorted based on
   * their creation date. <br>
   * The more recent a role was created, the lower it is in the hierarchy. This is handled by {@link
   * #getPosition()} and it is most likely the method you want. If, for some reason, you want the
   * actual position of the Role then this method will give you that value.
   *
   * @return The true, Discord stored, position of the {@link net.dv8tion.jda.core.entities.Role
   *     Role}.
   */
  int getPositionRaw();
   ...
   *
   * @return Never-null String containing the name of this {@link net.dv8tion.jda.core.entities.Role
   *     Role}.
   */
  String getName();
  ...
  /**
   * Whether this {@link net.dv8tion.jda.core.entities.Role Role} is hoisted <br>
  ...
  /**
   * The {@code long} representation of the literal permissions that this {@link
   * net.dv8tion.jda.core.entities.Role Role} has. <br>
   * <b>NOTE:</b> these do not necessarily represent the permissions this role will have in a {@link
  ...
  /**
   * Whether this role is the @everyone role for its {@link net.dv8tion.jda.core.entities.Guild
   * Guild}, which is assigned to everyone who joins the {@link net.dv8tion.jda.core.entities.Guild
   * Guild}.
   *
   * @return True, if and only if this {@link net.dv8tion.jda.core.entities.Role Role} is the public
   *     role for the {@link net.dv8tion.jda.core.entities.Guild Guild} provided by {@link
   *     #getGuild()}.
   ...
   * @throws IllegalArgumentException if the provided Role is null or not from the same {@link
  ...
  /**
   * Creates a new {@link net.dv8tion.jda.core.entities.Role Role} in the specified {@link
   ...
   * @throws net.dv8tion.jda.core.exceptions.PermissionException If the logged in account does not
   *     have the {@link net.dv8tion.jda.core.Permission#MANAGE_ROLES} Permission and every
   *     Permission the provided Role has
  ...
  /**
   * The {@link net.dv8tion.jda.core.managers.RoleManager RoleManager} for this Role. In the
   * RoleManager, you can modify all its values.
   *
  ...
  /**
   * The {@link net.dv8tion.jda.core.managers.RoleManagerUpdatable RoleManagerUpdatable} for this
   * Role. In the Manager, you can modify all its values.
   *
   * <p>This can be used to bulk update role properties. It requires to call an {@code update()}
   * method.
   *
   * @return The {@link net.dv8tion.jda.core.managers.RoleManagerUpdatable RoleManagerUpdatable} for
   *     this Role
   */
   ...
   *
   * <ul>
   *   <li>{@link net.dv8tion.jda.core.requests.ErrorResponse#UNKNOWN_ROLE} <br>
   *       If the the role was already deleted.
   *   <li>{@link net.dv8tion.jda.core.requests.ErrorResponse#MISSING_PERMISSIONS
   *       MISSING_PERMISSIONS} <br>
   *       The send request was attempted after the account lost {@link
   *       net.dv8tion.jda.core.Permission#MANAGE_ROLES Permission.MANAGE_ROLES} in the channel.
   *   <li>{@link net.dv8tion.jda.core.requests.ErrorResponse#MISSING_ACCESS MISSING_ACCESS} <br>
   ...
   *     permission to {@link net.dv8tion.jda.core.Permission#MANAGE_ROLES MANAGE_ROLES}
   * @throws net.dv8tion.jda.core.exceptions.HierarchyException If the role is too high in the role
