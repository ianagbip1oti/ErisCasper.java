...
public interface Member extends IMentionable, IPermissionHolder {
   ...
   *
   * <p>This can be used to get the Member's VoiceChannel using {@link
  ...
  /**
   * The game that the user is currently playing. <br>
   * If the user is not currently playing a game, this will return null.
   *
   * @return Possibly-null {@link net.dv8tion.jda.core.entities.Game Game} containing the game that
   *     the {@link net.dv8tion.jda.core.entities.User User} is currently playing.
   */
  Game getGame();

  /**
   * Returns the {@link net.dv8tion.jda.core.OnlineStatus OnlineStatus} of the User. <br>
   * If the {@link net.dv8tion.jda.core.OnlineStatus OnlineStatus} is unrecognized, will return
   * {@link net.dv8tion.jda.core.OnlineStatus#UNKNOWN UNKNOWN}.
   *
   * @return The current {@link net.dv8tion.jda.core.OnlineStatus OnlineStatus} of the {@link
   ...
   *
   * <p>This can be changed using {@link
   * net.dv8tion.jda.core.managers.GuildController#setNickname(Member, String)
  ...
  /**
   * The roles applied to this Member. <br>
   * The roles are ordered based on their position.
   *
   * <p>A Member's roles can be changed using the <b>addRolesToMember</b>,
   * <b>removeRolesFromMember</b>, and <b>modifyMemberRoles</b> methods in {@link
   * net.dv8tion.jda.core.managers.GuildController GuildController}.
   *
   * <p><b>The Public Role ({@code @everyone}) is not included in the returned immutable list of
   * roles <br>
   * It is implicit that every member holds the Public Role in a Guild thus it is not listed
   * here!</b>
   *
   ...
   *
   * <p>This is determined by the color of the highest role assigned to them that does not have the
   * default color. <br>
  ...
  /**
   * The Permissions this Member holds in the specified {@link net.dv8tion.jda.core.entities.Channel
   * Channel}. <br>
   * Permissions returned by this may be different from {@link #getPermissions()} due to the
   * Channel's {@link net.dv8tion.jda.core.entities.PermissionOverride PermissionOverrides}.
   *
   * @param channel The {@link net.dv8tion.jda.core.entities.Channel Channel} of which to get
   *     Permissions for
  ...
  /**
   * Whether this Member can interact with the provided {@link net.dv8tion.jda.core.entities.Role
   * Role} (kick/ban/move/modify/delete/etc.)
   *
  ...
  /**
   * Whether this Member can interact with the provided {@link net.dv8tion.jda.core.entities.Emote
   * Emote} (use in a message)
   *
  ...
  /**
   * Checks whether this member is the owner of its related {@link
   ...
   * the first time after joining the guild. <br>
   * The default channel is the channel with the highest position in which the member has {@link
   * net.dv8tion.jda.core.Permission#MESSAGE_READ Permission.MESSAGE_READ} permissions. If this
   * requirement doesn't apply for any channel in the guild, this method returns {@code null}.
   *
   * @return The {@link net.dv8tion.jda.core.entities.TextChannel TextChannel} representing the
   *     default channel for this member or null if no such channel exists.
   */
  @Nullable
