...
public interface ApplicationInfo extends ISnowflake {
   ...
   *
   * @return The description of the bot's application or an empty {@link String} if no description
   *     is defined
   */
  String getDescription();

  /**
   * The icon id of the bot's application. <br>
  ...
  /**
   * The icon-url of the bot's application. <br>
   * The application icon is <b>not</b> necessarily the same as the bot's avatar!
   *
   ...
   *
   * @param permissions Possibly empty {@link java.util.Collection Collection} of {@link
   ...
   * Unnecessary query parameters are stripped.
   *
   * @param permissions {@link net.dv8tion.jda.core.Permission Permissions} that should be requested
   *     via invite.
   * @return The link used to invite the bot
   */
   ...
   *
   * @param guildId The id of the pre-selected guild.
   * @param permissions Possibly empty array of {@link net.dv8tion.jda.core.Permission Permissions}
  ...
  /**
   * The {@link net.dv8tion.jda.core.JDA JDA} instance of this ApplicationInfo (the one logged into
   * this application's bot account).
   *
  ...
  /**
   * The name of the bot's application. <br>
