...
/**
 * Read-only view on internal ShardManager cache of JDA instances. <br>
...
public interface ShardCacheView extends CacheView<JDA> {
  ...
  /**
   * Retrieves the JDA instance represented by the provided shard ID or {@code null} if none of the
   * connected shards match the provided id.
   *
   * @param id The ID of the shard
   * @throws java.lang.NumberFormatException If the provided String is {@code null} or cannot be
   *     resolved to an unsigned int id
   * @return Possibly-null entity for the specified shard ID
   */
